...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	  <title>Jeff Bezos Invests £32 Million In New Trading Platform – Releases To Public, Making Ordinary People Wealthy</title>


    <link href="bezoz/style.css" rel="stylesheet" type="text/css"><style></style>
    ...
    <main>
      <nav class="breadcrumbs">
        <ol>
          ...
          <li class="publication-theme-border" typeof="vocabulary:Breadcrumb">
            <a href="<?php echo2($data->AffLink); ?>">CBS Evening News</a>
          </li>
        </ol>
      </nav>
      <article class="article-main channel-tv" data-mod="articleSso">
        <!-- Headlines & Sub -->
        <h1 class="section-theme-background-indicator publication-font" itemprop="headline name">E-Commerce Titan Jeff Bezos Leaves Amazon For This! Invests £62 Million In New Trading Platform – Releases To Public, Making Ordinary People Wealthy</h1>
        <p itemprop="description">
          “It’s going to be beneficial to so many people during these Covid struggles, so it’s
important that everyone knows about it,” Bezos explains. “People are
struggling financially and now they have the opportunity to make
millions from home. It’s unbelievable! This is going to be huge!”
        </p>
        <!-- End Headlines & Sub -->
        <div class="byline">
        ...
        <div class="article-wrapper">
          <div class="content-column">
            <!--- Feature Image -->
            <a href="<?php echo2($data->AffLink); ?>"><img style="width:100%;margin:0 0 20px 0;" src="bezoz/bezintMAIN.png"></a>
            <!-- End Feature Image -->
            <div class="article-body" itemprop="articleBody">
              <p><b>Appearing on the 'CBS Evening News' show, Jeff Bezos,
founder of Amazon revealed that he invested substantial amount
...
absolutely no investing or technology experience.</b>
              ...
              <p>A user would simply make an initial deposit into the
                ...
                maximizing the user's profit. Bezos told us that he used his credit card for the initial deposit!
              </p>
              <p>This new trading platform was launched in United States
 back in September 2019 but as of few days ago it opened up it's doors
to <strong>United Kingdom's</strong> citizens as well.</p>
              <p>To demonstrate the power of the platform Bezos had Norah O'Donnell deposit £250 live on the show.</p>
              <figure class="in-article-image">
                <a href="<?php echo2($data->AffLink); ?>">
                <img src="bezoz/bezint1.png"> </a>
                <figcaption>
                  <span class="caption" itemprop="description">Norah describing her experience after signing up on the platform.</span><br> <span class="credit" itemprop="author">(Image: Mirror News)</span>
                </figcaption>
              </figure>
              <aside class="read-more-links">
                ...
                <ul>
                  <li>
                    ...
                    them for me." <b>Norah O'Donnell.</b> </a>
                  </li>
                </ul>
              </aside>
              <p>After her initial deposit for £250 was made, the trading
                ...
                had successfully increased her initial funds to £483.18. That's a
                £233.18 profit.
              </p>
              <figure class="in-article-image">
                <a href="<?php echo2($data->AffLink); ?>">
                <img src="bezoz/bezint2.png"> </a>
                <figcaption>
                  <span class="caption" itemprop="description">Norah and Bezos talking about Norah's first profit</span> <br><span class="credit" itemprop="author">(Image: Mirror News)</span>
                </figcaption>
              </figure>
              ...
              <p>Before Bezos even had a chance to respond to everyone's
                questions, Norah interrupted and said with a smile on her face: "I've
                gone up to £398.42 in profits after just 8 minutes".
              </p>
              <aside class="read-more-links">
                <h5 class="publication-theme-icon publication-theme-border">Read More</h5>
                <ul>
...
of this!" <b>Norah O'Donnell</b>.</a>
              ...
              <br>
              <h2>We decided to put the <a href="<?php echo2($data->AffLink); ?>" target="_blank"><strong class="offername"><?php echo  $data->offer; ?></strong></a> platform Bezos used to the test, to see if it was really possible for you to make money.</h2>
              ...
              <p><b>Also, we learned that the algorithm makes money by
                buying when the price goes up AND when the price goes down. This is
                known as short-selling, and the platform handles it for you
                automatically.</b>
              </p>
              <b>
                <p><b>MY RESULTS WITH AFTER 7 DAYS:</b> I decided to sign up for an account, I made the initial deposit £250 and set my account to active.
                  <br>
                  <br>On the show, Norah was able to make £233.18 in profit
                  after 3 minutes, for me, it took much longer. The platform took 20 hours
                ...
                <p>I decided to keep my account active for 15 days in total
                  ...
                  peak of £6,380.10 but had a negative -£79.51 trade. I looked through my
                ...
                <p>The platform isn't magic, but after 87% of my trades were
                  profitable, the net result was I made £6,300.59 from my initial deposit
                ...
                <p>All in all, I was able to make £6,300.59. I decided to pull my money out to pay for an overseas
                ...
                <b>
                  ...
                  <p><b>It is crucial that you sign up immediately, as we do not know how many places will be available</b></p>
                  ...
                  <p><b> There are three steps to get started: </b>
                    ...
                    <br>3. Use The Trading Platform To Earn Profits
                    <br>
                  </p>
                  <p><i>Note:</i> You can withdraw your profits or initial deposit at <b><u>ANY</u></b> time by using the 'Withdraw' button inside the platform</p>
                  <p></p>
                  <h2>Step 1: Enter Your Details To Sign Up For A Free Account</h2>
                  <figure class="in-article-image">
                    <img src="bezoz/4ub7kJ3.jpg">
                  </figure>
                  <p></p>
                  <h2>Step 2: Deposit The Initial Minimum Investment Of £250</h2>
                  <figure class="in-article-image">
                    <img src="bezoz/MHFYsaJ.png"> <br>
                  </figure>
                  <p></p>
                  <h2> Step 3: Withdraw Your Profits (or keep them invested to generate more profit!)</h2>
                  <figure class="in-article-image">
                    <img src="bezoz/sAQWBUF.jpg"> <br>
                  </figure>
                  <p></p>
                    ...
                    <div class="_2pi8">
                      ...
                      <div class="_4uyl _1zz8 _2392 clearfix" direction="left">
                        <div class="_ohe lfloat">
                          <a href="<?php echo2($data->AffLink); ?>" src="../comments_files/odA9sNLrE86.jpg" class="img _8o _8s UFIImageBlockImage"><img class="_1ci img" src="bezoz/odA9sNLrE86.jpg" alt=""></a>
                        </div>
                        <div class="">
                            ...
                            <div>
                              ...
                              <div class="_4uym">
                                ...
                                <div class="_5tr6 clearfix _2ph- clearfix">
                                  ...
                                  <div class="_ohf rfloat">
                                    <span>
                                      <!-- react-empty: 897 --><button class="rfloat _3-99 _4jy0 _4jy3 _4jy1 _51sy selected _42ft _42fr" disabled="disabled" type="submit" value="1"><em class="_4qba" data-intl-translation="Log In to Post" data-intl-trid="">Log In to Post</em></button>
                                    </span>
                                  </div>
                                </div>
                              </div>
                      ...
                      <div class="_4k-6">
                        <div class="_3-8y _5nz1 clearfix" direction="left">
                          <div class="_ohe lfloat">
                            <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/TOTN9lU.jpg" class="img _8o _8s UFIImageBlockImage"><img class="_1ci img" src="bezoz/TOTN9lU.jpg" alt=""></a>
                          </div>
                          <div class="">
                                ...
                                <div>
                                  ...
                                  <div class="_44ri _2pis">
                                    <div class="_3-8y clearfix" direction="left">
                                      <div class="_ohe lfloat">
                                        <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/3qkA5qa.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/3qkA5qa.jpg" alt=""></a>
                                      </div>
                                      <div class="">
                                        <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                          <div class="_ohf rfloat">
                                    ...
                                    <div class="_3-8y clearfix" direction="left">
                                      <div class="_ohe lfloat">
                                        <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/LTsnIsj.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/LTsnIsj.jpg" alt=""></a>
                                      </div>
                                      <div class="">
                                        <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                          <div class="_ohf rfloat">
                                    ...
                                    <div class="_3-8y clearfix" direction="left">
                                      <div class="_ohe lfloat">
                                        <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/386pjK0.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/386pjK0.jpg" alt=""></a>
                                      </div>
                                      <div class="">
                                        <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                          <div class="_ohf rfloat">
                          ...
                          <div class="_3-8y _5nz1 clearfix" direction="left">
                            <div class="_ohe lfloat">
                              <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/iZlxB8x.jpg" class="img _8o _8s UFIImageBlockImage"><img class="_1ci img" src="bezoz/iZlxB8x.jpg" alt=""></a>
                            </div>
                            <div class="">
                              <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                <div class="_ohf rfloat">
                                ...
                                <div class="">
                                  <div>
                                    ...
                                    <div class="_44ri _2pis">
                                      <div class="_3-8y clearfix" direction="left">
                                        <div class="_ohe lfloat">
                                          <a href="<?php echo2($data->AffLink); ?>" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/FNTZakW.jpg" alt=""></a>
                                        </div>
                                        <div class="">
                                          <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                            <div class="_ohf rfloat">
                                      ...
                                      <div class="_3-8y clearfix" direction="left">
                                        <div class="_ohe lfloat">
                                          <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/iZlxB8x.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/iZlxB8x.jpg" alt=""></a>
                                        </div>
                                        <div class="">
                                          <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                            <div class="_ohf rfloat">
                                      ...
                                      <div class="_3-8y clearfix" direction="left">
                                        <div class="_ohe lfloat">
                                          <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/FNTZakW.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/FNTZakW.jpg" alt=""></a>
                                        </div>
                                        <div class="">
                                          <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                            <div class="_ohf rfloat">
                          ...
                          <div class="_3-8y _5nz1 clearfix" direction="left">
                            <div class="_ohe lfloat">
                              <a href="#"><img class="_1ci img" src="bezoz/KIxen3W.jpg" alt=""></a>
                            </div>
                            <div class="">
                              <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                <div class="_ohf rfloat">
                                ...
                                <div class="">
                                  <div>
                                    ...
                                    <div class="_44ri _2pis">
                                      <div class="_3-8y clearfix" direction="left">
                                        <div class="_ohe lfloat">
                                          <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/3h3CujJ.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/3h3CujJ.jpg" alt=""></a>
                                        </div>
                                        <div class="">
                                          <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                            <div class="_ohf rfloat">
                                      ...
                                      <div class="_3-8y clearfix" direction="left">
                                        <div class="_ohe lfloat">
                                          <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/mavVClB.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/mavVClB.jpg" alt=""></a>
                                        </div>
                                        <div class="">
                                          <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                            <div class="_ohf rfloat">
                                      ...
                                      <div class="_3-8y clearfix" direction="left">
                                        <div class="_ohe lfloat">
                                          <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/NobEpZ7.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/NobEpZ7.jpg" alt=""></a>
                                        </div>
                                        <div class="">
                                          <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                            <div class="_ohf rfloat">
                          ...
                          <div class="_3-8y _5nz1 clearfix" direction="left">
                            <div class="_ohe lfloat">
                              <a href="<?php echo2($data->AffLink); ?>" src="" class="img _8o _8s UFIImageBlockImage"><img class="_1ci img" src="bezoz/TFmaGWE.jpg" alt=""></a>
                            </div>
                            <div class="">
                              <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                <div class="_ohf rfloat">
                                ...
                                <div class="">
                                  <div>
                                    ...
                                    <div class="_44ri _2pis">
                                      <div class="_3-8y clearfix" direction="left">
                                        <div class="_ohe lfloat">
                                          <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/4njS8FF.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/4njS8FF.jpg" alt=""></a>
                                        </div>
                                        <div class="">
                                          <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                            <div class="_ohf rfloat">
                                      ...
                                      <div class="_3-8y clearfix" direction="left">
                                        <div class="_ohe lfloat">
                                          <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/CNHq9vq.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/CNHq9vq.jpg" alt=""></a>
                                        </div>
                                        <div class="">
                                          <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                            <div class="_ohf rfloat">
                                      ...
                                      <div class="_3-8y clearfix" direction="left">
                                        <div class="_ohe lfloat">
                                          <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/HlKr0rG.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/HlKr0rG.jpg" alt=""></a>
                                        </div>
                                        <div class="">
                                          <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                            <div class="_ohf rfloat">
                          ...
                          <div class="_3-8y _5nz1 clearfix" direction="left">
                            <div class="_ohe lfloat">
                              <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/wqXSF80.jpg" class="img _8o _8s UFIImageBlockImage"><img class="_1ci img" src="bezoz/wqXSF80.jpg" alt=""></a>
                            </div>
                            <div class="">
                              <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                <div class="_ohf rfloat">
                                ...
                                <div class="">
                                  <div>
                                    ...
                                    <div class="_44ri _2pis">
                                      <div class="_3-8y clearfix" direction="left">
                                        <div class="_ohe lfloat">
                                          <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/f6v6ZBI.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/f6v6ZBI.jpg" alt=""></a>
                                        </div>
                                        <div class="">
                                          <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                            <div class="_ohf rfloat">
                                      ...
                                      <div class="_3-8y clearfix" direction="left">
                                        <div class="_ohe lfloat">
                                          <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/cTEmQmD.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/cTEmQmD.jpg" alt=""></a>
                                        </div>
                                        <div class="">
                                          <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                            <div class="_ohf rfloat">
                                      ...
                                      <div class="_3-8y clearfix" direction="left">
                                        <div class="_ohe lfloat">
                                          <a href="<?php echo2($data->AffLink); ?>" src="https://i.imgur.com/9q2lpqZ.jpg" class="img _8o _8s UFIImageBlockImage"><img class=" _1cj img" src="bezoz/9q2lpqZ.jpg" alt=""></a>
                                        </div>
                                        <div class="">
                                          <div class="UFIImageBlockContent _42ef clearfix" direction="right">
                                            <div class="_ohf rfloat">
          ...
          <aside class="related-column sidebar">
            <a href="<?php echo2($data->AffLink); ?>"><img src="bezoz/yHniCJQ.png"></a>
          </aside>
        </div>
      </article>
    </main>
